document.addEventListener('DOMContentLoaded', function () {
    ...
    function setDynamicVisible(show) {
        ...
        // Hide standard pagination markers in Dynamic View
    ...
    function initDynamicView() {
        ...
        // Feed the full centralized media collection
        if (window._allLoadedMedia && window._allLoadedMedia.length > 0) {
            window._dynamicGallery.setItems(window._allLoadedMedia);
        }
    }
